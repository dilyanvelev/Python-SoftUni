from python_oop.encaspsulation_exercise.wild_cat_zoo.project.worker import Worker
from python_oop.encaspsulation_exercise.wild_cat_zoo.project.animal import Animal
from python_oop.encaspsulation_exercise.wild_cat_zoo.project.lion import Lion
from python_oop.encaspsulation_exercise.wild_cat_zoo.project.tiger import Tiger
from python_oop.encaspsulation_exercise.wild_cat_zoo.project.cheetah import Cheetah
from python_oop.encaspsulation_exercise.wild_cat_zoo.project.keeper import Keeper
from python_oop.encaspsulation_exercise.wild_cat_zoo.project.vet import Vet
from python_oop.encaspsulation_exercise.wild_cat_zoo.project.caretaker import Caretaker
from python_oop.encaspsulation_exercise.wild_cat_zoo.project.zoo import Zoo
...
class Zoo:
    ...
    def tend_animals(self):
        care_money = sum(animal.money_for_care for animal in self.animals)
        if self.__budget - care_money < 0:
            return "You have no budget to pay your workers. They are unhappy"
